...
func (c *userServiceClient) RegisterGame(ctx context.Context, in *RegisterGameRequest, opts ...grpc.CallOption) (*OnlineStatus, error) {
	out := new(OnlineStatus)
	err := c.cc.Invoke(ctx, "/UserService/RegisterGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_RegisterGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterGameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).RegisterGame(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/RegisterGame",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RegisterGame(ctx, req.(*RegisterGameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
