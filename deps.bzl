...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:mxcfI3IWHemX+5fEKt5uqIS/hdbaR7qzGfJYo5UyjJE=",
        version = "v1.44.176",
    )
    go_repository(
    ...
    go_repository(
        ...
        replace = "github.com/HdrHistogram/hdrhistogram-go",
        sum = "h1:nEjGZtKHMK92888VT6XkzKwyiW14v5FFRGeWq2uV7N0=",
        version = "v0.0.0-20200919145931-8dac23c8dac1",
    )
    go_repository(
    ...
    go_repository(
        ...
        replace = "github.com/moby/spdystream",
    ...
    go_repository(
        ...
        sum = "h1:8xtmYjUkqtahl50E0Bg/wjKI7K63krJrrLipbNj/fCU=",
        version = "v8.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JnZSkFP1/GLwKCEuuWVhsacvbDQIVa5BRwAwd+9k2Vw=",
        version = "v0.0.0-20230413205102-771768614e91",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Hw/iuQPdKtiB2B9YYh+NX8iv7U7eQu1rICPjr8NvxSo=",
        version = "v0.2.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:jaySwEIcS6cQELv1XiJSGqcicI93ln9RhHHa14zWpZc=",
        version = "v1.0.10",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jvr+TSivjObZmOKVdqlgeLtRhaDG27gE39PMuE2IJ24=",
        version = "v0.0.0-20220525125849-96fa0442e765",
    )
    ...
    go_repository(
        ...
        sum = "h1:jvcrwDvu1BfDeXYfo9nPEZIkI+OvpM9KaL6sSLjoFXY=",
        version = "v1.34.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BrrWb5gQlWuwvqGJs1xMV1Qtr+xQS6ri6A1QBT4rnz8=",
        version = "v0.26.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iu3o/SxaHVI7tKPtkGzD3M9IzrE21j+CUKH98NQJ8Ms=",
        version = "v0.0.0-20221011193443-fad74ee6edd9",
    )
    go_repository(
        name = "io_k8s_klog",
