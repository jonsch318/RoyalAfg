        ...
        <Layout>
            <div className="font-sans p-20">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            in this Agreement) refers to the owner of Royalafg (Jonas Schneider).
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Royalafg, accessible from{" "}
                            <a href="http://royalafg.games" rel="external nofollow noopener">
                                http://royalafg.games
                            </a>
                        </p>
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and
                        store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser
                ...
                <p>
                    ...
                    cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/">Cookies: What Do They Do?</a>.
                </p>
                ...
                <ul>
                    <li>
                        By email: <a href="mailto:jonas.max.schneider@gmail.com">jonas.max.schneider@gmail.com</a>
                    </li>
                </ul>
            </div>
        </Layout>
