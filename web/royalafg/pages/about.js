                ...
                <div className="md:px-10 md:py-8 p-4">
                    ...
                    <div className="cardList grid md:gap-20 gap-5 md:grid-cols-2 md:grid-rows-1">
                        <div className="card bg-gray-300 rounded-lg p-12 flex flex-col hover:opacity-75 transition-opacity duration-150">
                            ...
                            <h2 className="md:text-3xl text-xl font-medium text-center font-sans" >Contact</h2>
                        </div>
                        <div className="card bg-gray-300 rounded-lg p-12 flex flex-col hover:opacity-75 transition-opacity duration-150">
                    ...
                    <h1 className="text-center md:text-5xl text-3xl md:p-12 p-4 pt-8 font-sans font-semibold">This website and it's serverside environment was created out of a special learning achievement</h1>
                    <h2 className="text-center md:text-3xl text-2xl p-10 font-sans">It has not been subjected to stability and security testing! <span className="font-black ">Do Not Use In Production!</span></h2>
                </div>
            </div>
        </Layout>
    );
