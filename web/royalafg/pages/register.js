                    ...
                    <div className="content md:px-24 px-4">
                        <form onSubmit={handleSubmit(Submit)}>
                            ...
                            <FormItem>
                                ...
                                <input className="block px-4 py-2 rounded w-full" ref={register({ required: true })} type="date" id="birthdate" name="birthdate" />
                            ...
                            <FormItem>
                                ...
                                <input className="block px-4 py-2 rounded w-full" ref={register({ required: true, minLength: "3", maxLength: "100" })} name="email" id="email" type="email" placeholder="Your Email"></input>
                                {errors.birthdate && <span className="text-sm text-red-700">This field is required</span>}
                            </FormItem>

                            <FormItem>
                                <input type="checkbox" className="p-2 border-none form-checkbox mr-4 text-blue-700" />
                                <span>I consent to the <a href="/legal/terms" className="font-sans text-blue-800">terms and conditions</a> and our <a href="/legal/privacy" className="font-sans text-blue-800">privacy statement</a></span>
                            </FormItem>

                            <input className="block w-full px-4 py-2  bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors duration-150 font-sans font-medium cursor-pointer" type="submit" value="Register" />
                            <span className="font-sans font-light text-sm mb-8">Or <a href="/login" className="font-sans text-blue-800">login</a> if you already have an account</span>
