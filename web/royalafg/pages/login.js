            ...
            <div className="bg-gray-300 md:rounded-md shadow-md">
                ...
                <div className="content md:px-24 px-4">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="block w-full px-4 py-2  bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors duration-150 font-sans font-medium cursor-pointer" type="submit" value="Log in" />
                        <span className="font-sans font-light text-sm mb-8">Or <a href="/register" className="font-sans text-blue-800">register</a> a new account</span>
